...
public sealed partial class WorldEntity
{
    ...
    private void SaveChunkCore(ChunkCoordinate coordinate, OctreeChunk chunk)
    {
    ...
    private int GetMaximumPacketLength() => checked(12 + ChannelCount * (4 + Octree.GetMaximumSize(ChunkShift)));
